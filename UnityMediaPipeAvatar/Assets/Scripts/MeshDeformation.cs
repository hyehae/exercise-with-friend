...
public class MeshDeformation : MonoBehaviour
{
    ...
    void ApplyBoneBasedDistortion()
    {
        ...
        skin.bones[9].position = skin.bones[9].parent.position + ((skin.bones[9].position - skin.bones[9].parent.position) * bodySize);
        skin.bones[7].position = skin.bones[7].parent.position + ((skin.bones[7].position - skin.bones[7].parent.position) * bodySize);
        for (int i = 0; i < 52; i++) // bodySize
        {
            if (i != 8)
            {
        ...
        skin.bones[8].localScale = new Vector3(bodyCorpulent * bodySize, bodyCorpulent * bodySize, bodyCorpulent * bodySize);
        ...
        skin.bones[4].localScale = new Vector3(rightArmCorpulence * rightArmSize, rightArmCorpulence * rightArmSize, rightArmCorpulence * rightArmSize);
        ...
        skin.bones[2].localScale = new Vector3(leftArmCorpulence * leftArmSize, leftArmCorpulence * leftArmSize, leftArmCorpulence * leftArmSize);
        ...
        skin.bones[13].localScale = new Vector3(rightLegCorpulence * rightLegSize, rightLegCorpulence * rightLegSize, rightLegCorpulence * rightLegSize);
        ...
        skin.bones[28].localScale = new Vector3(leftLegCorpulence * leftLegSize, leftLegCorpulence * leftLegSize, leftLegCorpulence * leftLegSize);


        // head
        skin.bones[6].position = skin.bones[6].parent.position + (skin.bones[6].position - skin.bones[6].parent.position) * headSize1;
        skin.bones[5].localScale = new Vector3(headSize2 * headSize1, headSize2 * headSize1, headSize2 * headSize1);
    }
